...
Генерация паролей
- длина пароля от шести до восьми символов;
...
- через открытый или зашифрованный (AES256 на ключе из хеша пароля) файл JSON;
- добавление секретов вручную.

Безопасность
- вход в приложение может быть защищён PIN-кодом или строгой биометрией;
- секреты и хеш PIN-кода хранятся в зашифрованном виде (AES256);
...
- дневная, системная и ночная темы оформления;
