...
### 2.6.5
Изменения в модуле OTPauthUriParser.  
...
Объект TokensRepository переименован в TokensTrigger и вынесен в отдельный модуль.  
Функция checkBiometricInDevice() вынесена в отдельный модуль.