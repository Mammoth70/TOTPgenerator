...
Отказ от использования android:onClick в файлах макетов. Вместо этого сделаны программные установки всех листенеров через setOnClickListener.  
...
В меню удалены группы. Добавлено меню чтения QR-кода. Изменена прозрачность некоторых иконок.
...
### 2.0.2
Изменения в макете. В файле activity_main.xml избавились от ConstraintLayout. Чтобы кнопка FAB могла взаимодействовать с coordinatorlayout был поправлен макет partial_fab_qr.xml.  
