...
Несовместимыми считаются секреты для генерации семи разрядных токенов, или с периодом генерации не равным 30-ти сек.
...
Внесены изменения в файлы OTPauthDataBase, OTPauthEntity и OTPauthDataRepo.
