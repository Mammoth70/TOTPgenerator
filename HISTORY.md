...
### 1.8.3
Переписана функция parseOTPauth в модуле Parser.  
Добавлена функция isValidBase32 - расширенная проверка секрета Base32 на валидность.  
В форму ввода добавлена проверка на валидность ключа.  
...
### 1.8.4
Переписан TokensAdapter. Удален футер из кода, а в макет добавлены атрибуты paddingBottom и clipToPadding, создающие внутренний отступ.