...
- можно загрузить секрет генерации вручную или отсканировав QR-код (схема otpauth://);
- можно перенести секреты из Google Authenticator отсканировав QR-код (схема otpauth-migration://);
...
- есть возможность сдвига времени генерации токенов вперёд до пяти секунд для улучшения UX;
