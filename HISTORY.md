...
Несовместимыми считаются секреты для генерации 7-ми разрядных токенов, или с периодом генерации не равным 30-ти сек.
...
### 2.9.3
В список несовместимых со схемой "otpauth-migration://" добавлены секреты, длина которых не кратна 8-ми символам Base32.